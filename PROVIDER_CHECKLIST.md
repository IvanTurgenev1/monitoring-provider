...
The [provider-paas](https://github.com/crossplane/provider-paas) repository can be
used as a starting point for new providers. For [terrajet](https://github.com/crossplane/terrajet)-based providers, the
[provider-jet-paas](https://github.com/crossplane-contrib/provider-jet-paas) is
available.
...
- [ ]  Code is licensed under the [Apache 2.0
  License](https://github.com/crossplane/provider-paas/blob/main/LICENSE)
...
- [ ]  Update
  [OWNERS.md](https://github.com/crossplane/provider-paas/blob/main/OWNERS.md)
...
- [ ]  Ensure `hack/boilerplate.go.txt` (used in Code generation) includes
  ...
  [https://github.com/crossplane/provider-paas/blob/main/hack/boilerplate.go.txt](https://github.com/crossplane/provider-paas/blob/main/hack/boilerplate.go.txt)
...
The [provider-paas](https://github.com/crossplane/provider-paas)
...
- [ ] Create a [Crossplane
  ...
  configuration (see
  [package/crossplane.yaml)](https://github.com/crossplane/provider-paas/blob/main/package/crossplane.yaml)
...
- [ ] Utilize GitHub workflows from
  <https://github.com/crossplane/provider-paas/tree/main/.github/workflows>
...
- [ ] Enable Issues on your project and configure Issue paass (examples at:
  [.github/ISSUE_TEMPLATE](https://github.com/crossplane/provider-paas/tree/master/.github/ISSUE_TEMPLATE))
- [ ] Create Pull Request paass: (example:
  [PULL_REQUEST_TEMPLATE.md](https://github.com/crossplane/provider-paas/blob/master/.github/PULL_REQUEST_TEMPLATE.md))
